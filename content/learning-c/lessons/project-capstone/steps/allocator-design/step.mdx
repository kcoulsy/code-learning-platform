...
You've chosen to build a custom memory allocator - excellent choice! In this step, we'll design the architecture of your allocator, understanding how `malloc()` and `free()` work at a fundamental level.
